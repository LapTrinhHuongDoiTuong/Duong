...
public abstract class taiKhoan {
	...
	// Kiểm tra chuỗi nếu chứa kí tự chữ thì sẽ sai vì số tài khoản không có 
	public boolean kiemTraSo(String mP) {
		if (mP.contains(".*[a-zA-Z].*"))
				return false;
			return true;
		}
	...
	public void DangNhap() {
		...
		do {
			...
			System.out.println("Nhập mật khẩu: ");
			mkDangNhap = sc.nextLine();
			if (tenDangNhap.equals(this.tenTaiKhoan) || mkDangNhap.equals(this.matKhau)) 
				System.out.println("Tên đăng nhập hoặc mật khẩu không trùng khớp!");
		}while(tenDangNhap.equals(this.tenTaiKhoan) || mkDangNhap.equals(this.matKhau));
	}
